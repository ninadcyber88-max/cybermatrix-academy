...
export function StudentAIAssistant() {
  ...
  return (
    <div className="w-full rounded-2xl bg-zinc-900/90 border border-cyan-500/30 backdrop-blur-md shadow-[0_0_35px_rgba(6,182,212,0.2)] flex flex-col h-[550px] overflow-hidden">
