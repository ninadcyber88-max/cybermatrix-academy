  ...
  return (
    <header className="relative w-full border-b border-cyan-500/25 bg-zinc-950/95 backdrop-blur-md font-mono select-none z-50">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-3.5 flex items-center justify-between gap-4">
        ...
        {/* 2. CENTER: OPERATIONAL STATUS & KERNEL TELEMETRY */}
        <div className="hidden md:flex items-center gap-2.5 px-4 py-2 rounded-full bg-zinc-900/90 border border-cyan-500/35 shadow-[0_0_18px_rgba(6,182,212,0.18)] text-xs mx-auto">
        ...
        {/* 3. FAR RIGHT: GLOWING TIME & DD-MM-YYYY WIDGET */}
        <div className="flex items-center space-x-3 shrink-0">
          <div className="flex items-center gap-3 px-3.5 py-2 rounded-2xl bg-zinc-900/90 border border-cyan-400/50 shadow-[0_0_20px_rgba(6,182,212,0.25)]">
            ...
            <div className="flex items-center space-x-1.5 text-zinc-300">
              ...
              <span className="text-xs font-bold text-zinc-200 tracking-widest">
