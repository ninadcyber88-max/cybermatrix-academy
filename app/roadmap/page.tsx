...
export default function ExactRoadmapPage() {
  const [searchQuery, setSearchQuery] = useState('');

  return (
    <div className="min-h-screen bg-[#1c2438] text-zinc-100 font-sans selection:bg-cyan-500/30 selection:text-cyan-300 relative overflow-hidden">
          ...
          <div className="flex items-center space-x-2">
            <div className="relative w-44 sm:w-64">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-1.5 bg-[#1f283d] border border-zinc-700/60 rounded-md text-xs font-mono text-zinc-200 placeholder-zinc-500 focus:outline-none focus:border-cyan-500 transition"
              />
            </div>
            <button className="p-2 rounded-md bg-[#1f283d] border border-zinc-700/60 text-zinc-400 hover:text-cyan-300 transition">
      ...
      {/* 3. BLUEPRINT GRID BACKGROUND CONTAINER */}
      <div className="relative w-full pb-28 pt-10">
        ...
        <div className="max-w-xl mx-auto px-4 relative z-10 space-y-6">
          {FOUNDATIONS.map((item, index) => (
            <div key={item.id} className="relative flex flex-col items-center">
              ...
              {/* Connecting Down Arrow to Next Step */}
        ...
        {/* 5. CENTER SECTION BOX: CYBER SECURITY CAREER SKILLS */}
        ...
        {/* Horizontal Connecting Branch Line to 4 Columns */}
            ...
            {CAREER_TRACKS.map((col, idx) => (
              <div key={idx} className="flex flex-col space-y-4">
                ...
                <div className="space-y-3 flex-1">
                  ...
                  {/* AI SECURITY SPECIAL GLOWING CYBORG ROBOT (Col 4) */}
