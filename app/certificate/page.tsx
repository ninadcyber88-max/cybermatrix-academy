...
export default function CertificatePage() {
  ...
  return (
    <div className="min-h-screen bg-[#070a12] text-zinc-100 font-mono selection:bg-cyan-500/30 selection:text-cyan-300">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="print:hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8 pb-4 border-b border-zinc-800">
          <Link 
            href="/" 
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={handlePrint}
              className="flex items-center space-x-2 px-4 py-2 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-black font-black text-xs tracking-wider transition shadow-[0_0_15px_rgba(6,182,212,0.4)]"
            >
        ...
        {/* Dynamic Controls Box (Hidden during print) */}
        ...
        <div 
          ref={certRef}
          className="relative w-full max-w-4xl mx-auto aspect-[1.414/1] bg-gradient-to-br from-zinc-950 via-[#0a1120] to-zinc-950 border-4 border-cyan-500/40 rounded-3xl p-8 md:p-12 shadow-[0_0_50px_rgba(6,182,212,0.15)] flex flex-col justify-between overflow-hidden text-center select-none"
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-center space-x-3 mb-2">
              <div className="w-10 h-10 rounded-xl bg-zinc-950 border border-cyan-400 flex items-center justify-center shadow-[0_0_15px_rgba(6,182,212,0.5)]">
                <ShieldCheck className="w-6 h-6 text-cyan-300" />
              </div>
              <h2 className="text-base md:text-lg font-black tracking-widest text-cyan-300 drop-shadow-[0_0_10px_rgba(6,182,212,0.6)]">
                CYBERMATRIX ACADEMY
              </h2>
            </div>
          ...
          <div className="relative z-10 my-auto py-4">
            ...
            <h1 className="text-2xl sm:text-4xl md:text-5xl font-black tracking-wider text-white mt-2 mb-3 drop-shadow-[0_0_16px_rgba(255,255,255,0.3)]">
            ...
            <div className="inline-block mt-3 px-4 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-400/40 text-cyan-300 text-sm md:text-base font-bold shadow-[0_0_15px_rgba(6,182,212,0.2)]">
              {trackName}
            </div>
          </div>

          {/* Certificate Footer / Signatures & QR Verification */}
          <div className="relative z-10 pt-4 border-t border-zinc-800/80 flex items-end justify-between text-left text-[11px]">
            
            {/* Signature 1: Lead Architect */}
            <div className="space-y-1">
              <p className="font-serif italic text-base md:text-lg text-cyan-300">Ninad Pawar</p>
              <div className="w-28 md:w-36 h-0.5 bg-cyan-500/50"></div>
              <p className="font-bold text-zinc-300 text-[10px]">NINAD PAWAR</p>
              <p className="text-zinc-500 text-[9px]">Lead Security Architect & Instructor</p>
            </div>

            {/* Middle: Official Cryptographic Seal */}
            <div className="flex flex-col items-center justify-center text-center">
              <div className="w-12 h-12 rounded-full border-2 border-dashed border-cyan-400/70 flex items-center justify-center animate-[spin_12s_linear_infinite]">
                <Award className="w-6 h-6 text-cyan-300" />
              </div>
              <span className="text-[9px] text-cyan-400 mt-1 font-bold tracking-widest">VERIFIED AUTHENTIC</span>
            </div>

            {/* Signature 2: Verification Hash & QR */}
            <div className="space-y-1 text-right">
              <p className="text-zinc-400 text-[9px]">CREDENTIAL ID:</p>
              <p className="font-mono font-black text-cyan-300 text-[10px]">{certId}</p>
              <p className="text-zinc-500 text-[9px]">ISSUED: {issueDate}</p>
              <p className="text-green-400 text-[8.5px] font-bold">STATUS: ACTIVE & VERIFIED</p>
            </div>
